-- Insert sample marketplace data for testing
...
-- Add sample products from thrift/second-hand
...
('Vintage Wooden Bookshelf', 'Beautiful teak wood bookshelf in excellent condition. Perfect for any home library.', 3500, 3, 2, 'good', true, true, 8.5, 2.3, 1, '["https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400"]'),
('Refurbished Laptop - Dell XPS', 'Professionally refurbished laptop with new SSD and battery. Great for students and professionals.', 25000, 1, 1, 'like-new', true, true, 7.8, 45.2, 3, '["https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=400"]'),
...
('Second-hand iPhone 12', 'Well-maintained iPhone 12 with original box and accessories. Battery health 89%.', 35000, 1, 1, 'good', true, true, 6.5, 78.3, 1, '["https://images.unsplash.com/photo-1592910147811-e52f7915bb3f?w=400"]'),
('Upcycled Denim Jacket', 'Vintage denim jacket upcycled with sustainable patches and organic thread.', 2200, 4, 3, 'like-new', true, true, 8.7, 1.2, 8, '["https://images.unsplash.com/photo-1544966503-7cc5ac882d5f?w=400"]'),
...
('Vintage Ceramic Planters', 'Set of 3 vintage ceramic planters in excellent condition. Perfect for indoor plants.', 1500, 4, 6, 'good', true, true, 8.0, 1.8, 5, '["https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=400"]');

-- Insert some order items to show transaction history
INSERT INTO marketplace_orders (user_id, vendor_id, total_amount, status, eco_coins_used, eco_coins_earned, total_carbon_footprint) VALUES
('00000000-0000-0000-0000-000000000001', 1, 25000, 'delivered', 500, 250, 45.2),
('00000000-0000-0000-0000-000000000002', 2, 1800, 'shipped', 0, 90, 3.2),
('00000000-0000-0000-0000-000000000003', 3, 3500, 'delivered', 200, 175, 2.3);